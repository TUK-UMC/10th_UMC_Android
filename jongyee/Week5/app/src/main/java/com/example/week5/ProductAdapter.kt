...
import com.example.week5.databinding.ItemGridProductBinding
import com.example.week5.databinding.ItemHomeProductBinding

class ProductAdapter(
    private var productList: List<Product> = emptyList(),
    private val isGrid: Boolean = false,
    private val onHeartClick: ((Product) -> Unit)? = null,
